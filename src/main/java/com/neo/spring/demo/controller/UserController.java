...
public class UserController extends UserValidation {
	...
	@PutMapping(value = "/editUser/{uname}", produces = MediaType.APPLICATION_JSON_VALUE)
	...
	//soft delete
	@PutMapping(value = "/softDelete/{uname}", produces = MediaType.APPLICATION_JSON_VALUE)
	...
	//hard delete
	@DeleteMapping(value = "/hardDelete/{uname}", produces = MediaType.APPLICATION_JSON_VALUE)
